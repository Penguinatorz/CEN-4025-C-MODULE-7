...
public class todoSystem {
	 ...
	 * @return 
	 */
	public ArrayList<String> getToDoString() {
		return todoList;
	}
 ...
 */
	...
	public List<databasePassing> listAll(){
		List<databasePassing> databaseList = new ArrayList();
		Configuration con = new Configuration().configure().addAnnotatedClass(databasePassing.class);
		SessionFactory sf = con.buildSessionFactory();
		Session session = sf.openSession();
		
		Query query =session.createQuery("From databasePassing");
